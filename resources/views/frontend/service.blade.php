					...
					<div class="row">
						<div class="col">
							<div class=" breadcrumb-holder">
								...
								<!-- Title -->
								<h4 class="h4-sm steelblue-color" style="text-align:center;">Our Services</h4>
				 		...
				 		<div class="col-lg-8">
							<div class="tab-content" id="pills-tabContent">
								...
								<div class="tab-pane fade show active" id="tab-11" role="tabpanel" aria-labelledby="tab11-list">
									...
									<!-- Image -->
									<div class="tab-img">
										<img class="img-fluid" src="{{asset('frontend/images/pediatrics_1000x500.jpg')}}" alt="tab-image">
									</div>
									<!-- Text -->
									...
									<!-- Button -->
									<a href="{{ route('frontend.singleservices') }}" class="btn btn-blue blue-hover mt-30">View More Details</a>
								...
								<div class="tab-pane fade" id="tab-12" role="tabpanel" aria-labelledby="tab12-list">
									...
									<!-- Image -->
									<div class="tab-img">
										<img class="img-fluid" src="{{asset('frontend/images/hematology_1000x500.jpg')}}" alt="tab-image">
									</div>
									<!-- Text -->
									<p>An enim nullam tempor sapien gravida donec enim ipsum blandit
									   porta justo integer odio velna vitae auctor integer congue magna at pretium
								...
								<div class="tab-pane fade" id="tab-13" role="tabpanel" aria-labelledby="tab13-list">
									...
									<!-- Image -->
									<div class="tab-img">
										<img class="img-fluid" src="{{asset('frontend/images/mri_1000x500.jpg')}}" alt="tab-image">
									</div>
								...
								<div class="tab-pane fade" id="tab-14" role="tabpanel" aria-labelledby="tab14-list">
									...
									<!-- Image -->
									<div class="tab-img">
										<img class="img-fluid" src="{{asset('frontend/images/x-ray_1000x500.jpg')}}" alt="tab-image">
									</div>
									<!-- Text -->
									<p>An enim nullam tempor sapien gravida donec enim ipsum blandit
									   porta justo integer odio velna vitae auctor integer congue magna at pretium
