...
<head>
    ...
    <meta name="description" content="MediLink - Medical & Medical Health Landing Page Template">
    ...
    <link href="{{asset('frontend/css-1?family=Lato:400,700,900')}}" rel="stylesheet">
