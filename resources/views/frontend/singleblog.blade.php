							...
							<div class="breadcrumb-holder">
								...
								<nav aria-label="breadcrumb">
								  	<ol class="breadcrumb"style="justify-content:center;">
								    	...
								    	<li class="breadcrumb-item"><a href="{{ route('frontend.blog') }}">Our Blog</a></li>
								    	<li class="breadcrumb-item active" aria-current="page">Blog Post</li>
								  	</ol>
								</nav>

								<!-- Title -->
								<h4 class="h4-sm steelblue-color" style="text-align:center;">Single Blog</h4>
				 		...
				 		<div class="col-lg-8">
					 		<div class="single-blog-post pr-30">
								...
								<div class="author-senoff">
									...
									<!-- Avatar -->
									<img src="{{asset('frontend/images/review-author-4.jpg')}}" alt="author-avatar">
										...
										<!-- BLOG POST #1 -->
								 		<div class="col-md-6">
								 			<div class="blog-post">
									 			...
									 			<div class="blog-post-img">
													<img class="img-fluid" src="{{asset('frontend/images/blog/post-2-img.jpg')}}" alt="blog-post-image">
												</div>
								 		...
								 		<div class="col-md-6">
								 			<div class="blog-post">
								 				...
								 				<!-- BLOG POST IMAGE -->
									 			<div class="blog-post-img">
													<img class="img-fluid" src="{{asset('frontend/images/blog/post-3-img.jpg')}}" alt="blog-post-image">
												</div>
								...
								<div class="single-post-comments">
									...
									<div class="media mt-50">
										...
										<!-- Comment-1 Avatar -->
									  	<img class="mr-3" src="{{asset('frontend/images/post-author-1.jpg')}}" alt="comment-avatar">
									 	...
									 	<div class="media-body">
										    ...
										    <div class="media mt-3">
										    	...
										    	<!-- Comment-2 Avatar -->
										      	<a href="#" class="pr-3">
										        	<img src="{{asset('frontend/images/post-author-2.jpg')}}" alt="comment-avatar">
										      	</a>
									...
									<div class="media mt-40">
										...
										<!-- Comment-4 Avatar -->
									  	<img class="mr-3" src="{{asset('frontend/images/post-author-3.jpg')}}" alt="comment-avatar">
									...
									<div class="media mt-40">
										...
										<!-- Comment-4 Avatar -->
									  	<img class="mr-3" src="{{asset('frontend/images/post-author-4.jpg')}}" alt="comment-avatar">
