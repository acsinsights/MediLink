        ...
        <div class="col-sm-6 col-md-4">
            <div class="card overflow-hidden" style="min-width: 12rem">
                ...
                <div class="card-body position-relative">
                    ...
                    <div class="display-4 fs-5 mb-2 fw-normal font-sans-serif text-warning">{{ $messages->count() }}</div>
                    <a class="fw-semi-bold fs-10 text-nowrap" href="{{ route('admin.message.index') }}">See all
                        <span class="fas fa-angle-right ms-1" data-fa-transform="down-1"></span>
                    </a>
                </div>
            </div>
        ...
        <div class="col-sm-6 col-md-4">
            <div class="card overflow-hidden" style="min-width: 12rem">
                ...
                <div class="card-body position-relative">
                    ...
                    <div class="display-4 fs-5 mb-2 fw-normal font-sans-serif text-warning">{{ $testimonials->count() }}
                    </div>
                    <a class="fw-semi-bold fs-10 text-nowrap" href="{{ route('admin.testimonial.index') }}">See all
                        <span class="fas fa-angle-right ms-1" data-fa-transform="down-1"></span>
                    </a>
                </div>
            </div>
